...
// ============================================
const PERSONAS = {
    'beby.manis': { gender: 'female', panggilan: 'Beby', umur: 20, kerjaan: 'mahasiswi', statusCinta: 'single abis putus' },
    'agak.koplak': { gender: 'male', panggilan: 'Koplak', umur: 23, kerjaan: 'admin medsos', statusCinta: 'in relationship' },
    'pretty.sad': { gender: 'female', panggilan: 'Pretty', umur: 23, kerjaan: 'karyawan startup', statusCinta: 'situationship' },
    'bang.juned': { gender: 'male', panggilan: 'Juned', umur: 22, kerjaan: 'mahasiswa skripsi', statusCinta: 'single sibuk' },
    'strawberry.shortcake': { gender: 'female', panggilan: 'Straw', umur: 22, kerjaan: 'fresh graduate', statusCinta: 'in relationship' },
    'chili.padi': { gender: 'male', panggilan: 'Chili', umur: 20, kerjaan: 'pedagang online', statusCinta: 'pedekate' },
    'little.fairy': { gender: 'female', panggilan: 'Fairy', umur: 19, kerjaan: 'content creator', statusCinta: 'single happy' },
    'sejuta.badai': { gender: 'male', panggilan: 'Badai', umur: 22, kerjaan: 'musisi indie', statusCinta: 'single baperan' },
    'satria.bajahitam': { gender: 'male', panggilan: 'Satria', umur: 21, kerjaan: 'mekanik', statusCinta: 'jomblo akut' },
    'cinnamon.girl': { gender: 'female', panggilan: 'Cinna', umur: 24, kerjaan: 'guru TK', statusCinta: 'single searching' }
};
        ...
        const response = await fetch(DEEPSEEK_API_URL, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    ...
                    { role: 'user', content: `Buat curhat singkat sebagai ${characterName} dengan mood ${mood}` }
                ],
                temperature: 1.0,
                max_tokens: 100
            })
